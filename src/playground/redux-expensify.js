...
//things we are going to do with this module
//ADD_EXPENSE
const addExpense = ({
  description = "",
  note = "",
  ...
  type: "ADD_EXPENSE",
  expense: {
    //uuid allows for creation of unique universal identifiers
    id: uuid(),
    description,
    note,
    amount,
...
//start at January 1t 1970 (set by Unix epoch)
//need to be numbers ie: 33400, 10, -203
